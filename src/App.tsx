...
function App() {
  const [currentView, setCurrentView] = useState<'home' | 'day1' | 'day2' | 'day3' | 'day4' | 'day5' | 'day6' | 'day7' | 'day8' | 'day9' | 'day10' | 'day11' | 'day12' | 'day13' | 'day14' | 'day15' | 'day16' | 'day17' | 'day18' | 'day19' | 'day20' | 'day21' | 'day22' | 'day23' | 'day24' | 'day25' | 'day26' | 'day27'>('home');
  ...
  const handleDayClick = (dayNumber: number) => {
    if (dayNumber === 1) {
      ...
      setCurrentView('day10');
    } else if (dayNumber === 11) {
      setCurrentView('day11');
    } else if (dayNumber === 12) {
      setCurrentView('day12');
    } else if (dayNumber === 13) {
      setCurrentView('day13');
    } else if (dayNumber === 14) {
      setCurrentView('day14');
    } else if (dayNumber === 15) {
      setCurrentView('day15');
    } else if (dayNumber === 16) {
      setCurrentView('day16');
    } else if (dayNumber === 17) {
      setCurrentView('day17');
    } else if (dayNumber === 18) {
      setCurrentView('day18');
    } else if (dayNumber === 19) {
      setCurrentView('day19');
    } else if (dayNumber === 20) {
      setCurrentView('day20');
    } else if (dayNumber === 21) {
      setCurrentView('day21');
    } else if (dayNumber === 22) {
      setCurrentView('day22');
    } else if (dayNumber === 23) {
      setCurrentView('day23');
    } else if (dayNumber === 24) {
      setCurrentView('day24');
    } else if (dayNumber === 25) {
      setCurrentView('day25');
    } else if (dayNumber === 26) {
      setCurrentView('day26');
    } else if (dayNumber === 27) {
      setCurrentView('day27');
    }
  };
  ...
  if (currentView === 'day1') {
    return <Day1 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day2') {
    return <Day2 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day3') {
    return <Day3 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day4') {
    return <Day4 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day5') {
    return <Day5 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day6') {
    return <Day6 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day7') {
    return <Day7 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day8') {
    return <Day8 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day9') {
    return <Day9 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day10') {
    return <Day10 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day11') {
    return <Day11 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day12') {
    return <Day12 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day13') {
    return <Day13 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day14') {
    return <Day14 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day15') {
    return <Day15 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day16') {
    return <Day16 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day17') {
    return <Day17 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day18') {
    return <Day18 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day19') {
    return <Day19 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day20') {
    return <Day20 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day21') {
    return <Day21 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day22') {
    return <Day22 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day23') {
    return <Day23 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day24') {
    return <Day24 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day25') {
    return <Day25 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day26') {
    return <Day26 onBack={() => setCurrentView('home')} onNavigateToDay27={navigateToDay27} />;
  }

  if (currentView === 'day27') {
    return <Day27 onBack={() => setCurrentView('home')} />;
  }
